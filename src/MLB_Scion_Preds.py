...
class scionPREDS:
	def __init__(self, predspath, app_ver):
		...
		self._preds_iposml_txt_fname = os.path.join(self.preds_subfolder_path, (self._preds_stem_fname + "_iPOSML_" + self._preds_timestamp.strftime('%Y%m%d%H%M%S') + ".txt"))
		...
		self._preds_iposml_cwd_txt_fname = os.path.join(self.preds_path, (self._preds_stem_fname + "_iPOSML" + ".txt"))
		...
		self._preds_iposml_desktop_txt_fname = os.path.join(os.path.expanduser('~'),'Desktop',(self._preds_stem_fname + "_iPOSML" + ".txt"))
		...
		self._preds_opmidl_attrib = "HMidLine"
		self._preds_opvig_attrib = "Vig"
		self._preds_opt_attrib = "BookieTotal"
		self._preds_V_Id_attrib = "V_Id"
		self._preds_V_Sname_attrib = "V_Team"
		self._preds_V_Bookie_Price_attrib = "V_Bookie_Price"
		self._preds_V_Bookie_Prob_attrib = "V_Bookie_Prob"
		...
		self._preds_H_Bookie_Price_attrib = "H_Bookie_Price"
		self._preds_H_Bookie_Prob_attrib = "H_Bookie_Prob"
		...
		self._preds_Ens1_VoterProfile_attrib = "V113PM210_2023_VoterProfile"
		self._preds_Ens1_MajorityVote_attrib = "V113PM210_2023_MajorityVote"
		self._preds_Ens1_NumVoters_attrib = "V113PM210_2023_NumVoters"
		self._preds_Ens1_VoteAgreement_attrib = "V113PM210_2023_VoteAgreement"
		self._preds_Ens1_HProbability_attrib = "V113PM210_2023_H_Probability"
		self._preds_Ens1_HPrice_attrib = "V113PM210_2023_H_Price"
		self._preds_Ens1_PlayPosition_attrib = "V113PM210_2023_PlayPosition"
		self._preds_Ens2_VoterProfile_attrib = "V113PM150_2023_VoterProfile"
		self._preds_Ens2_MajorityVote_attrib = "V113PM150_2023_MajorityVote"
		self._preds_Ens2_NumVoters_attrib = "V113PM150_2023_NumVoters"
		self._preds_Ens2_VoteAgreement_attrib = "V113PM150_2023_VoteAgreement"
		self._preds_Ens2_HProbability_attrib = "V113PM150_2023_H_Probability"
		self._preds_Ens2_HPrice_attrib = "V113PM150_2023_H_Price"
		self._preds_Ens2_PlayPosition_attrib = "V113PM150_2023_PlayPosition"
		...
		self._preds_iPos_V_Bookie_Price_attrib = "VLINE"
		self._preds_iPos_H_Bookie_Price_attrib = "HLINE"
		self._preds_iPos_Defense_HPrice_attrib = "DEF_H"
		self._preds_iPos_Offense_HPrice_attrib = "OFF_H"
		self._preds_iPos_Ens1_HPrice_attrib = "ENS1_PM210_HPrice"
		self._preds_iPos_Ens2_HPrice_attrib = "ENS2_PM150_HPrice"
		self._preds_iPos_Scion_Play_attrib = "PRED"
		self._preds_iPos_Comments_attrib = "NOTES"
		
		self._preds_iPosML_GId_attrib = "GID"
		self._preds_iPosML_H_Bookie_Price_attrib = "HLINE"
		self._preds_iPosML_Ens1_HPrice_attrib = "ENS1_PM210_HPrice"
		self._preds_iPosML_Ens2_HPrice_attrib = "ENS2_PM150_HPrice"
		
		self._preds_iPlay_GId_attrib = "Game_Id"
		self._preds_iPlay_BookiePricePlay_attrib = "OPL_Play"
		...
		self._preds_iPlay_Ens1_HPrice_attrib = "ENS1_PM210_HPrice"
		self._preds_iPlay_Ens2_HPrice_attrib = "ENS2_PM150_HPrice"
		...
		self._preds_ePlay_BookiePrice_attrib = "OPL"
		...
		self._preds_verbose_cols =	[
										...
										self._preds_opmidl_attrib,
										self._preds_opvig_attrib,
										self._preds_opt_attrib,
										self._preds_V_Id_attrib,
										self._preds_V_Sname_attrib,
										self._preds_V_Bookie_Price_attrib,
										self._preds_V_Bookie_Prob_attrib,
										...
										self._preds_H_Bookie_Price_attrib,
										self._preds_H_Bookie_Prob_attrib,
		...
		self._preds_ipos_cols =		[
										...
										self._preds_iPos_V_Bookie_Price_attrib,
										self._preds_iPos_H_Team_Sname_attrib,
										self._preds_iPos_H_Bookie_Price_attrib,
		...
		self._preds_iposml_int_cols =	[]

		self._preds_iposml_float_cols =	[	
											self._preds_iPos_H_Bookie_Price_attrib,
											self._preds_iPos_Ens1_HPrice_attrib,
											self._preds_iPos_Ens2_HPrice_attrib
										]

		self._preds_iposml_str_cols =	[
											self._preds_iPos_GId_attrib,
										]
	...
	def initPredsDict(self):
		self.preds_current_game_dict =	{
											...
											self._preds_opmidl_attrib:MLB_dbvar.NO_DATA,
											self._preds_opvig_attrib:MLB_dbvar.NO_DATA,
											self._preds_opt_attrib:MLB_dbvar.NO_DATA,
											self._preds_V_Id_attrib:MLB_dbvar.NO_DATA,
											self._preds_V_Sname_attrib:MLB_dbvar.NO_DATA,
											self._preds_V_Bookie_Price_attrib:MLB_dbvar.NO_DATA,
											self._preds_V_Bookie_Prob_attrib:MLB_dbvar.NO_DATA,
											...
											self._preds_H_Bookie_Price_attrib:MLB_dbvar.NO_DATA,
											self._preds_H_Bookie_Prob_attrib:MLB_dbvar.NO_DATA,
	...
	def initPredsPosDict(self):
		self.preds_ipos_current_game_dict =	{
													...
													self._preds_iPos_V_Bookie_Price_attrib:str(MLB_dbvar.NO_DATA),
													self._preds_iPos_H_Bookie_Price_attrib:str(MLB_dbvar.NO_DATA),
	...
	def _createPredId(self, isExtended=True):
		...
		_midLine = self.getPreds_opmidl()
		_vig = self.getPreds_opvig()
		if isExtended:
			_predId = str(_dateStr.strftime(MLB_global.DATE_F) + "_MWK" + str(_monthweek) + "_" + _vSname + "@" + _hSname + "_" + str(_midLine) + "_" + str(_vig))
		else:
	...
	def initPredsALL(self, mupsDB):
		...
		self.setPreds_Bookie_Total(mupsDB.getCurrentMUPBOOKIETOTAL())
		self.setPreds_opmidl(mupsDB.getCurrentMUPBOOKIEML())
		self.setPreds_opvig(mupsDB.getCurrentMUPBookieVig())
		_hPrice, _vPrice = MLB_global.ConvertMiddleLineToPrices(self.getPreds_opmidl(), self.getPreds_opvig())
		_hProb = MLB_global.convertMoneyLinetoProb(_hPrice)
		_vProb = MLB_global.convertMoneyLinetoProb(_vPrice)
		self.setPreds_V_Bookie_Price(_vPrice)
		self.setPreds_V_Bookie_Prob(_vProb)
		self.setPreds_H_Bookie_Price(_hPrice)
		self.setPreds_H_Bookie_Prob(_hProb)
	...
	def setPreds_opmidl(self, newValue):self.preds_current_game_dict[self._preds_opmidl_attrib] = newValue
	def setPreds_opvig(self, newValue):self.preds_current_game_dict[self._preds_opvig_attrib] = newValue
	def setPreds_Bookie_Total(self, newValue):self.preds_current_game_dict[self._preds_opt_attrib] = newValue
	...
	def setPreds_V_Bookie_Price(self, newValue):self.preds_current_game_dict[self._preds_V_Bookie_Price_attrib] = newValue
	def setPreds_V_Bookie_Prob(self, newValue):self.preds_current_game_dict[self._preds_V_Bookie_Prob_attrib] = newValue
	...
	def setPreds_H_Bookie_Price(self, newValue):self.preds_current_game_dict[self._preds_H_Bookie_Price_attrib] = newValue
	def setPreds_H_Bookie_Prob(self, newValue):self.preds_current_game_dict[self._preds_H_Bookie_Prob_attrib] = newValue
	...
	def setPreds_iPos_V_Bookie_Price(self, newValue):self.preds_ipos_current_game_dict[self.preds_iPos_V_Bookie_Price_attrib] = newValue
	def setPreds_iPos_H_Bookie_Price(self, newValue):self.preds_ipos_current_game_dict[self.preds_iPos_H_Bookie_Price_attrib] = newValue
	...
	def setPreds_iPos_Ens2_HPrice(self, newValue):self.preds_ipos_current_game_dict[self.preds_iPos_Ens2_HPrice_attrib] = newValue
	...
	def getPreds_opmidl(self): return self.preds_current_game_dict[self._preds_opmidl_attrib]
	def getPreds_opvig(self): return self.preds_current_game_dict[self._preds_opvig_attrib]
	def getPreds_opt(self): return self.preds_current_game_dict[self._preds_opt_attrib]
	...
	def getPreds_V_Bookie_Price(self): return self.preds_current_game_dict[self._preds_V_Bookie_Price_attrib]
	def getPreds_V_Bookie_Prob(self): return self.preds_current_game_dict[self._preds_V_Bookie_Prob_attrib]
	...
	def getPreds_H_Bookie_Price(self): return self.preds_current_game_dict[self._preds_H_Bookie_Price_attrib]
	def getPreds_H_Bookie_Prob(self): return self.preds_current_game_dict[self._preds_H_Bookie_Prob_attrib]
	...
	def getPreds_iPos_V_Bookie_Price(self): return self.preds_ipos_current_game_dict[self.preds_iPos_V_Bookie_Price_attrib]
	def getPreds_iPos_H_Bookie_Price(self): return self.preds_ipos_current_game_dict[self.preds_iPos_H_Bookie_Price_attrib]
	...
	def getPreds_iPos_Ens2_HPrice(self): return self.preds_ipos_current_game_dict[self.preds_iPos_Ens2_HPrice_attrib]
	...
	def storeVerbosePreds(self):
		try:
			...
			self.preds_verbose_df[self._preds_opmidl_attrib] = self.preds_verbose_df[self._preds_opmidl_attrib].map(lambda x: '{:.1f}'.format(float(x)))
			self.preds_verbose_df[self._preds_opvig_attrib] = self.preds_verbose_df[self._preds_opvig_attrib].map(lambda x: '{:.1f}'.format(float(x)))
			self.preds_verbose_df[self._preds_opt_attrib] = self.preds_verbose_df[self._preds_opt_attrib].map(lambda x: '{:.1f}'.format(float(x)))
			self.preds_verbose_df[self._preds_V_Bookie_Price_attrib] = self.preds_verbose_df[self._preds_V_Bookie_Price_attrib].map(lambda x: '{:.1f}'.format(float(x)))
			self.preds_verbose_df[self._preds_V_Bookie_Prob_attrib] = self.preds_verbose_df[self._preds_V_Bookie_Prob_attrib].map(lambda x: '{:.2f}'.format(float(x)))
			...
			self.preds_verbose_df[self._preds_H_Bookie_Price_attrib] = self.preds_verbose_df[self._preds_H_Bookie_Price_attrib].map(lambda x: '{:.1f}'.format(float(x)))
			self.preds_verbose_df[self._preds_H_Bookie_Prob_attrib] = self.preds_verbose_df[self._preds_H_Bookie_Prob_attrib].map(lambda x: '{:.2f}'.format(float(x)))
	...
	def storePredsAsMarkdown(self):
		try:
			#set self.preds_iposml_df to be selected subset of ipo
	...
	def getBookiePrice(self, _sidePos):
		...
		try:
			if _sidePos == MLB_global.ACTION_LINE_HF or _sidePos == MLB_global.ACTION_LINE_HD:
				return self.getPreds_H_Bookie_Price()
			else:
				return self.getPreds_V_Bookie_Price()
		except Exception:
			print("\nscionPREDS.getBookiePrice(): Unexpected error encountered when getting bookie price for Scion play!")
			raise
	...
	def getBookiePricePlay(self, _sidePos):
		try:
			if _sidePos == MLB_global.ACTION_LINE_HF or _sidePos == MLB_global.ACTION_LINE_HD:
				_bookiePricePlay = f"{self.getPreds_H_Bookie_Price():.1f}"
			else:
				_bookiePricePlay = f"{self.getPreds_V_Bookie_Price():.1f}"
	...
	def updateiPosNoPlayPrices(self):
		...
		try:
			...
			_ens2Price = round(self.getPreds_Ens2_HWinPrice())
			...
			self.setPreds_iPos_Ens2_HPrice(_ens2Price)
		except Exception:
	...
	# Assumption: 1. predsObj contains HLine, VLine
	#			  2. cfgObj contains target (eg B1 HomeWin, G2 FaveWin)
		try:
			...
			vPrice = self.getPreds_V_Bookie_Price()
			hPrice = self.getPreds_H_Bookie_Price()
			...
			if ens not in MLB_global.MODEL_PROBENS:
				...
				elif ens == MLB_global.MODEL_PROBENS2: #V25.05a: active V113PM150)
	...
	@property
	def preds_opmidl_attrib(self): return self._preds_opmidl_attrib
	@property
	def preds_opvig_attrib(self): return self._preds_opvig_attrib
	@property
	def preds_opt_attrib(self): return self._preds_opt_attrib
	@property
	def preds_V_Id_attrib(self): return self._preds_V_Id_attrib
	@property
	def preds_V_Sname_attrib(self): return self._preds_V_Sname_attrib
	@property
	def preds_V_Bookie_Price_attrib(self): return self._preds_V_Bookie_Price_attrib
	@property
	def preds_V_Bookie_Prob_attrib(self): return self._preds_V_Bookie_Prob_attrib
	@property
	...
	@property
	def preds_H_Bookie_Price_attrib(self): return self._preds_H_Bookie_Price_attrib
	@property
	def preds_H_Bookie_Prob_attrib(self): return self._preds_H_Bookie_Prob_attrib
	@property
	...
	@property		
	def preds_iPos_V_Bookie_Price_attrib(self):return self._preds_iPos_V_Bookie_Price_attrib
	@property		
	def preds_iPos_H_Bookie_Price_attrib(self):return self._preds_iPos_H_Bookie_Price_attrib
	@property		
