...
class scionPREDS:
	def __init__(self, predspath, app_ver):
		...
		self._preds_iPos_Ens1_HPrice_attrib = "ENS_StatOnly_HPrice"
		self._preds_iPos_Ens2_HPrice_attrib = "ENS_LeanStatOnly_HPrice"
		...
		self._preds_iPlay_Ens1_HPrice_attrib = "ENS_PM150StatOnly_HPrice"
		self._preds_iPlay_Ens2_HPrice_attrib = "ENS_PM150LeanStatOnly_HPrice"
